...
def car_detail():
    ...
    car_model = input("What is the model "
                      "of you car? ")
    car_yr = int(input("What is the year "
                       "of you car? "))
    if 2022 >= car_yr >= 1998:
        print("Please Continue")
    else:
        print("Please enter your cars correct year "
              "between 1898 and 2022")
        car_yr = int(input("What is the year "
                           "of you car? "))
...
while run_again == "":
    ...
    items = [['Wheel Lock', 92.99], ['Steering Wheel Lock', 33.99], ['GPS Tracker', 239.00]]
    ...
    if total_budget >= 33.99 :
        ...
        if run_again == 'xxx':
            print("Thank You for using my app and hope you got an accessory you were looking for.")
